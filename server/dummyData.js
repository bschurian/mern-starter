...
export default function () {
  ...
  Ticket.count().exec((err, count) => {
    ...
    const ticket1 = new Ticket({ title: 'Kinoticket', cuid: 'cikqgkv4q01ck7453ualEn3hk', content: content1 });
    const ticket2 = new Ticket({ title: 'Bahnticket', cuid: 'cikqgkv4q01ck7453ualdn3hl', content: content2 });
